...
Source0  : https://files.pythonhosted.org/packages/14/49/9f23d33e5872446c8162d63f035f222c1d0d74d0fbe00cea9e2538351432/google-auth-oauthlib-0.5.1.tar.gz
...
%prep
%setup -q -n google-auth-oauthlib-0.5.1
cd %{_builddir}/google-auth-oauthlib-0.5.1
pushd ..
cp -a google-auth-oauthlib-0.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653333517
...
cp %{_builddir}/google-auth-oauthlib-0.5.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_auth_oauthlib/2b8b815229aa8a61e483fb4ba0588b8b6c491890
