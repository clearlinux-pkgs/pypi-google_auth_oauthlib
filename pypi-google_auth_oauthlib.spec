...
%prep
%setup -q -n google-auth-oauthlib-1.2.0
cd %{_builddir}/google-auth-oauthlib-1.2.0
pushd ..
cp -a google-auth-oauthlib-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702923854
