...
%prep
%setup -q -n google-auth-oauthlib-0.5.2
cd %{_builddir}/google-auth-oauthlib-0.5.2
pushd ..
cp -a google-auth-oauthlib-0.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654896749
...
cp %{_builddir}/google-auth-oauthlib-0.5.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_auth_oauthlib/2b8b815229aa8a61e483fb4ba0588b8b6c491890
