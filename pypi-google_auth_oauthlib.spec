...
Source0  : https://files.pythonhosted.org/packages/fb/87/e10bf24f7bcffc1421b84d6f9c3377c30ec305d082cd737ddaa6d8f77f7c/google_auth_oauthlib-1.2.2.tar.gz
...
%prep
%setup -q -n google_auth_oauthlib-1.2.2
cd %{_builddir}/google_auth_oauthlib-1.2.2
pushd ..
cp -a google_auth_oauthlib-1.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745421223
