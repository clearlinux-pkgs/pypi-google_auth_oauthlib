...
Source0  : https://files.pythonhosted.org/packages/f0/d0/3521515d13827eb4c68d3b45972ad49a21b02e486c589fdd3c2aee9b9065/google-auth-oauthlib-0.5.3.tar.gz
...
%prep
%setup -q -n google-auth-oauthlib-0.5.3
cd %{_builddir}/google-auth-oauthlib-0.5.3
pushd ..
cp -a google-auth-oauthlib-0.5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663201153
