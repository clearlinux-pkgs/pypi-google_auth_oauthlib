...
Source0  : https://files.pythonhosted.org/packages/98/76/3821fef3005f9a1e1d4ebd3c2ccb14f891de6b759f0146f46ded5e6b5158/google-auth-oauthlib-0.7.0.tar.gz
...
%prep
%setup -q -n google-auth-oauthlib-0.7.0
cd %{_builddir}/google-auth-oauthlib-0.7.0
pushd ..
cp -a google-auth-oauthlib-0.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666740334
