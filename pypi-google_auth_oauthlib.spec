...
Source0  : https://files.pythonhosted.org/packages/6a/34/c584323ea98fb596e71ade06c06d514de898c60498efc72311e18ebe2825/google-auth-oauthlib-1.1.0.tar.gz
...
%prep
%setup -q -n google-auth-oauthlib-1.1.0
cd %{_builddir}/google-auth-oauthlib-1.1.0
pushd ..
cp -a google-auth-oauthlib-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694467971
