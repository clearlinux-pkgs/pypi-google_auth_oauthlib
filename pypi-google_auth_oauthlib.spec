...
Source0  : https://files.pythonhosted.org/packages/e3/b4/ef2170c5f6aa5bc2461bab959a84e56d2819ce26662b50038d2d0602223e/google-auth-oauthlib-1.0.0.tar.gz
...
%prep
%setup -q -n google-auth-oauthlib-1.0.0
cd %{_builddir}/google-auth-oauthlib-1.0.0
pushd ..
cp -a google-auth-oauthlib-1.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675884806
